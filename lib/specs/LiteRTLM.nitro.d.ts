...
export interface LLMConfig {
     ...
     * @deprecated WAVE fork: prefer engineMaxTokens + outputMaxTokens.
     * Used as the fallback for both when they are unset.
     * @default 1024
     */
    maxTokens?: number;
    /**
     * Engine-wide KV-cache budget (total input + output tokens).
     * Must fit the bundle's compiled cache_length (2048 for stock Gemma 4).
     * @default 2048
     */
    engineMaxTokens?: number;
    /**
     * Per-call decode cap. Must stay within the bundle's compiled decode
     * chunk (<=256 for stock Gemma 4).
     * @default 256
     */
