...
namespace margelo::nitro::litertlm {
  ...
  public:
    ...
    // WAVE fork additions: split the conflated maxTokens knob into a
    // distinct engine-wide KV budget and per-call decode cap.
    std::optional<double> engineMaxTokens     SWIFT_PRIVATE;
    std::optional<double> outputMaxTokens     SWIFT_PRIVATE;

  public:
    LLMConfig() = default;
    explicit LLMConfig(std::optional<std::string> systemPrompt, std::optional<Backend> backend, std::optional<double> maxTokens, std::optional<double> temperature, std::optional<double> topK, std::optional<double> topP, std::optional<double> engineMaxTokens = std::nullopt, std::optional<double> outputMaxTokens = std::nullopt): systemPrompt(systemPrompt), backend(backend), maxTokens(maxTokens), temperature(temperature), topK(topK), topP(topP), engineMaxTokens(engineMaxTokens), outputMaxTokens(outputMaxTokens) {}
  ...
  struct JSIConverter<margelo::nitro::litertlm::LLMConfig> final {
    static inline margelo::nitro::litertlm::LLMConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::litertlm::LLMConfig(
        ...
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "engineMaxTokens"))),
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "outputMaxTokens")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::litertlm::LLMConfig& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "engineMaxTokens"), JSIConverter<std::optional<double>>::toJSI(runtime, arg.engineMaxTokens));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "outputMaxTokens"), JSIConverter<std::optional<double>>::toJSI(runtime, arg.outputMaxTokens));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "engineMaxTokens")))) return false;
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "outputMaxTokens")))) return false;
      return true;
    }
  };
